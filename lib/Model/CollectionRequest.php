 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CollectionRequest implements ArrayAccess
{
    /**
    ...
    public function setTClient($t_client)
    {
        ...
        if ($t_client < 0.0) {
            throw new \InvalidArgumentException('invalid value for $t_client when calling CollectionRequest., must be bigger than or equal to 0.0.');
        }
    ...
    public function setOffset($offset)
    {
        ...
        if ($offset < 0.0) {
            throw new \InvalidArgumentException('invalid value for $offset when calling CollectionRequest., must be bigger than or equal to 0.0.');
        }
    ...
    public function setLimit($limit)
    {
        ...
        if ($limit < 1.0) {
            throw new \InvalidArgumentException('invalid value for $limit when calling CollectionRequest., must be bigger than or equal to 1.0.');
        }
