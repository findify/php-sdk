...
/**
 * FeaturedRecommendationRequest Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class FeaturedRecommendationRequest implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'FeaturedRecommendationRequest';
    ...
    public function setTClient($t_client)
    {
        ...
        if ($t_client < 0.0) {
            throw new \InvalidArgumentException('invalid value for $t_client when calling FeaturedRecommendationRequest., must be bigger than or equal to 0.0.');
        }
