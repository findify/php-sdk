...
class DefaultApi
{
    ...
    /**
     * Operation recommendItemsItemIdViewedBoughtPost
     *
     * 
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function recommendItemsItemIdViewedBoughtPost($item_id, $recommendation)
    {
        list($response) = $this->recommendItemsItemIdViewedBoughtPostWithHttpInfo($item_id, $recommendation);
        return $response;
    }

    /**
     * Operation recommendItemsItemIdViewedBoughtPostWithHttpInfo
     *
     * 
     *
     * @param string $item_id  (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function recommendItemsItemIdViewedBoughtPostWithHttpInfo($item_id, $recommendation)
    {
        // verify the required parameter 'item_id' is set
        if ($item_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $item_id when calling recommendItemsItemIdViewedBoughtPost');
        }
        // verify the required parameter 'recommendation' is set
        if ($recommendation === null) {
            throw new \InvalidArgumentException('Missing the required parameter $recommendation when calling recommendItemsItemIdViewedBoughtPost');
        }
        // parse inputs
        $resourcePath = "/recommend/items/{item_id}/viewed/bought";
        $httpBody = '';
        $queryParams = array();
        $headerParams = array();
        $formParams = array();
